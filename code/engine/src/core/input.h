...
void InitializeInput(u64* MemoryRequirement, void* System);
void InputShutdown(void* System);

void InputUpdate(r64 DeltaTime);

VENG_API b8 IsKeyDown(keys Key);
VENG_API b8 IsKeyUp(keys Key);
VENG_API b8 WasKeyDown(keys Key);
VENG_API b8 WasKeyUp(keys Key);

void ProcessKey(keys Key, b8 Pressed);

VENG_API b8 IsButtonDown(buttons Button);
VENG_API b8 IsButtonUp(buttons Button);
VENG_API b8 WasButtonDown(buttons Button);
VENG_API b8 WasButtonUp(buttons Button);
VENG_API void GetMousePos(s32* X, s32* Y);
VENG_API void GetPrevMousePos(s32* X, s32* Y);
